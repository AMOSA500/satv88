    ...
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                <h4 class="page-title mb-0 text-primary">Compose Message</h4>
            </div>
            ...
            <div class="col-md-12 col-lg-4 col-xl-3">
                <div class="card">
                    <div class="list-group list-group-transparent mb-0 mail-inbox mail-inbox-elements pb-3">
                        ...
                        <a href="#" class="list-group-item list-group-item-action d-flex align-items-center font-weight-bold text-muted mb-2">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="sender" value="" >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
