            ...
            <ul class="nav nav-tabs nav-tabs-card">
                <li class="nav-item">
                    <a class="nav-link active"
                       href="instructor-account-edit.html#first"
                       data-toggle="tab">Account</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                       href="instructor-account-edit.html#second"
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active"
                    ...
                    <form action="#"
                        ...
                        <div class="form-group row">
                            <label for="phone"
                                   class="col-sm-3 col-form-label form-label">Phone Number</label>
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input id="phone"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8 offset-sm-3">
                                <div class="media align-items-center">
                                    <div class="media-left">
                                        <a href="instructor-account-edit.html#"
